  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          onClick={onNewGame}
          className="py-2 px-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold transition-colors"
        >
          New Game
        </button>
        <button
          onClick={onFlip}
          className="py-2 px-3 rounded-xl bg-[#16213e] hover:bg-[#1e2a4a] border border-[#2a2d4a] text-white text-sm font-semibold transition-colors"
        >
          Flip Board
        </button>
        <button
          ...
          className="py-2 px-3 rounded-xl bg-[#16213e] hover:bg-[#1e2a4a] border border-[#2a2d4a] text-white text-sm font-semibold transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Undo
        </button>
        <button
          ...
          className="py-2 px-3 rounded-xl bg-[#16213e] hover:bg-[#1e2a4a] border border-[#2a2d4a] text-amber-400 text-sm font-semibold transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Hint
        </button>
      </div>
      ...
      <div className="flex flex-col flex-1 min-h-0">
        ...
        <div className="flex-1 overflow-y-auto min-h-0 rounded-lg bg-[#0f0f23] border border-[#2a2d4a]" style={{ maxHeight: 220 }}>
          {pairs.length === 0 ? (
            <div className="flex items-center justify-center py-6 text-[#8b8fa8] text-sm">
              No moves yet
            </div>
          ) : (
            <table className="w-full text-sm">
              <tbody>
                {pairs.map(([white, black], i) => (
                  ...
                  >
                    <td className="px-2 py-1 text-[#8b8fa8] w-8 text-right font-mono text-xs">
                      {i + 1}.
                    </td>
